		...
		<div class="row">
			...
			<?php endwhile; endif;?>
				...
				<ul class="estilo-listagem">
					...
					<li class="text-flow">Vice-Presidente: Matheus Felipe Martins Feitosa, da empresa M Impressões Gráfica Rápida.</li>
					<li class="text-flow">Primeira Secretária: Marilucia da Cunha, da empresa Malu Equipamentos.</li>
					<li class="text-flow">Segundo Secretário: Washington Reis de Almeida, da empresa Bazar São Paulo.</li>
				...
				<ul class="estilo-listagem">
					<li class="text-flow">Ailson Carvalho Feitosa, da empresa Shopping das Festas.</li>
					<li class="text-flow">Francisco Derneval de Sá, da empresa Lojas Sarmento.</li>
					<li class="text-flow">Ednildo Soares de Araújo, da empresa Calçados Araújo.</li>
				</ul>
			</div>
		</div>
	</section>
